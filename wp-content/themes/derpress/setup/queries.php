<?php
	...
	/* <<<< QUERIES >>>> */
	function google_maps_format($address, $city, $state, $zip) {
	...
	function get_list_pt($pt, $args = false) {
		$default = array(
				'posts_per_page' => 4,
				'post_type'=> $pt,
				'orderby' => 'DATE',
